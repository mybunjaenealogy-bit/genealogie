...
const Chimere = (() => {
    ...
    async function init() {
        // A. On attend les données AVANT de lancer quoi que ce soit
        await loadData('./datatrees/genealogie.json'); 

        // B. Une fois les données là, on configure le DOM
        ...
        // C. On lance la boucle d'animation
        requestAnimationFrame(loop);
    }

    return { init, handleImage, resetView, exportPNG, addPerson, rebuild, get DB() { return DB; }, cam, P };
}) ();
